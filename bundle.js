...
window.GetMain = function()
{
	var m = 
	{
		init : function (idCnv, idMsgDiv, d) {
			...
			this.OnObject = function(data)
			{
				if (!data)
					$(this.idMsgDiv).text("Bez popisu");
				else
					$(this.idMsgDiv).text(DescFromData(data));
			};
		},	
...
},{"./utils.js":4,"jquery-browserify":2,"svgjs":3}],2:[function(require,module,exports){
